...
try {
    ...
    if ($domaincount -eq 1) {
		...
		<div class=`"nasa__block`"><button class=`"button`" onclick=`"window.open('https://security.microsoft.com/homepage?tid=$($Customer.CustomerId)')`"><h3><i class=`"fab fa-skype`">&nbsp;&nbsp;&nbsp;</i>Defender Portal</h3></button></div>
